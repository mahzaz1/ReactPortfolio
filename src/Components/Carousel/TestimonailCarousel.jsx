...
const TestimonialCarousel = () => {
    const products = [
        {
            name: "Ezaz is an exceptionally talented programmer—smart, reliable, and professional. You won't be disappointed",
            description: 'Rodolfo E. Shannon',
            image: image1
        },
        {
            name: 'Ezaz efficiently manages our outdated website, providing quick and invaluable support. We would be lost without him',
